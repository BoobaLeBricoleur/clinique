...
ini_set("display_errors", 1);
 ...
 $result = mysqli_query($mysqli, "select * from clinique.hospitalisations where DateAdmi between '".$date1."' and '".$date2."';");
...
if($row == 0){
 ...
 $pdf->Cell(40,10,"Compte-rendu des pre-admissions pour la semaine du ".$date1." au ".$date2);
 $pdf->MultiCell(0,70,"Date : ".$DateAdmi." heure : ". $Heure_inter." nom medecin : Dr.". $nomMedecin." avec le motif : ". $nomMotif." pour le patient : ". $Nom. " ".$Prenom);
 $pdf->Output();
 ob_end_flush(); 
